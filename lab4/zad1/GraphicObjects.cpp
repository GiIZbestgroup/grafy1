...
void GraphicObjects::createLines(int numberofNodes,std::vector<Point> &points,std::vector<std::vector<int>> &connectionArray,std::vector<sf::VertexArray> &lines,std::vector<sf::CircleShape> &arrows)
{
